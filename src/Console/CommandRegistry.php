...
final class CommandRegistry
{
    ...
    public static function commands(): array
    {
        return [
            ...
            'ai:analyze-site' => 'Analyze crawl flexibility, extraction opportunities, risks, page types, suggested recipes, and safe crawl limits.',
            'ai:explain-plan' => 'Explain an AI/rule-based crawl flexibility report in concise operator-friendly text.',
            'search:providers' => 'List safe search discovery providers and API/import configuration status.',
            'search:web' => 'Run API/import-based web search discovery or offline suggestions without scraping search result pages.',
            'search:discover' => 'Classify search results into crawl seed types such as journal, issue, article, sitemap, and feed.',
            'search:to-seeds' => 'Convert search/discovery JSON into a clean URL seed list.',
            ...
            'mail:to-seeds' => 'Convert extracted mail links into crawl seed URLs with optional domain filtering.',
            'ml:strategies' => 'List ML crawl strategies and safe adaptive crawling techniques.',
            'ml:train' => 'Train a lightweight deterministic URL relevance model from positive/negative examples or feedback.',
            'ml:score' => 'Score candidate URLs with a trained crawl relevance model.',
            'ml:adaptive-plan' => 'Generate a budgeted adaptive crawl plan using priority, ML relevance, diversity, and exploration.',
            'ml:feedback' => 'Append manual URL relevance feedback for retraining and review workflows.',
            'ml:export-training' => 'Export ML-ready URL feature rows as JSON or JSONL.',
            ...
            'extract:types' => 'List extraction output types: links, text, HTML, images, PDFs, tables, lists, headings, pagination, components, patterns, and dictionary.',
            'extract:components' => 'Extract common page components and repeated element groups from saved HTML or one URL.',
            'extract:pagination' => 'Detect pagination controls from saved HTML or one URL, including numbered, ellipsis, prev/next, A-Z, dropdown, load-more, infinite-scroll, cursor, offset, keyset, and token styles.',
            ...
            'extract:recipe' => 'Run reusable extraction recipes with selector provenance, transforms, components, and quality scores.',
            'extract:quality' => 'Score extraction results for required fields, provenance coverage, and component completeness.',
